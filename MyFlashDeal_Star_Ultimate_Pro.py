...
st.markdown('<div style="text-align:center;"><span class="icon-circle">🔒</span><span class="icon-circle">👤</span><span class="icon-circle">✋</span><span class="icon-circle">🔑</span></div>',unsafe_allow_html=True)
